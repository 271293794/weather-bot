...
const url = 'https://free-api.heweather.net/s6/weather/forecast?location=112.3796463,26.96238708&key=8d7dbf63886d45c29657c12d8fe1085e';
...
request(url, (error, response, body) => {
  ...
  data = {
    basic: { location: "南充" },
    daily_forecast: [{ date: '2021-11-27' }]

  }
  let mailOptions = {
    from: '"预报君" <271293794@qq.com>', // sender address
    to: '1461158247@qq.com', // list of receivers
